...
class PlugLab_Dropdown_Select2_Custom_Control extends WP_Customize_Control {
    ...
    public function enqueue() {
        wp_enqueue_script('pluglab-select2-js', PLUGLAB_PLUGIN_URL_INC . 'customizer/js/select2.full.min.js', array('jquery'), '4.0.13', true);
        wp_enqueue_script('pluglab-custom-controls-js', PLUGLAB_PLUGIN_URL_INC . 'customizer/js/customizer.js', array('pluglab-select2-js'), '1.0', true);
        wp_enqueue_style('pluglab-custom-controls-css', PLUGLAB_PLUGIN_URL_INC . 'customizer/css/customizer.css', array(), '1.1', 'all');
        wp_enqueue_style('pluglab-select2-css', PLUGLAB_PLUGIN_URL_INC . 'customizer/css/select2.min.css', array(), '4.0.13', 'all');
    }
