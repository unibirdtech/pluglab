...
class PlugLab_Sortable_Repeater_Custom_Control extends WP_Customize_Control {
    ...
    public function enqueue() {
        wp_enqueue_script('pluglab-custom-controls-js', PLUGLAB_PLUGIN_URL_INC . 'customizer/js/customizer.js', array('jquery', 'jquery-ui-core'), '1.0', true);
