...
class PlugLab_Toggle_Switch_Custom_control extends WP_Customize_Control {
    ...
    public function enqueue() {
        wp_enqueue_style('pluglab1-custom-controls-css', PLUGLAB_PLUGIN_URL_INC . 'customizer/css/customizer.css', array(), '1.0', 'all');
    }
