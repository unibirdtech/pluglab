 ...
 */
class PlugLab_customizer_repeater extends WP_Customize_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		if ( file_exists( $icons=PLUGLAB_PLUGIN_INC . 'customizer/icons.php' ) ) {
	...
	public function enqueue() {
		wp_enqueue_style( 'font-awesome', PLUGLAB_PLUGIN_URL_INC . 'customizer/css/font-awesome.min.css', array() );

		wp_enqueue_style( 'customizer-repeater-admin-stylesheet', PLUGLAB_PLUGIN_URL_INC . 'customizer/css/admin-style.css', array() );

		wp_enqueue_style( 'wp-color-picker' );

		wp_enqueue_script( 'customizer-repeater-script', PLUGLAB_PLUGIN_URL_INC . 'customizer/js/customizer_repeater.js', array( 'jquery', 'jquery-ui-draggable', 'wp-color-picker' ), '', true );

		wp_enqueue_script( 'customizer-repeater-fontawesome-iconpicker', PLUGLAB_PLUGIN_URL_INC . 'customizer/js/fontawesome-iconpicker.min.js', array( 'jquery' ), '', true );

		wp_enqueue_style( 'customizer-repeater-fontawesome-iconpicker-script', PLUGLAB_PLUGIN_URL_INC . 'customizer/css/fontawesome-iconpicker.min.css', array(), '' );
	}
...
>
    ...
    private function new_tab_checkbox($value='yes') {
        ...
        <div class="customize-control-title">
            ...
            <span style='display:inline'><input type="checkbox" <?php if ($value == 'yes') echo 'checked'; ?> class="customizer-repeater-checkbox" <?php echo $value; ?> name="custom_checkbox" value="yes" ></span>
        </div>
        <?php
    }
