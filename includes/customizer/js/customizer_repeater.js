...
function customizer_repeater_refresh_general_control_values() {
    ...
    jQuery('.customizer-repeater-general-control-repeater').each(function () {
        ...
        th.find('.customizer-repeater-general-control-repeater-container').each(function () {
            ...
            var newtab = jQuery(this).find('.customizer-repeater-checkbox').val();
            if (!id) {
            ...
            if (text !== '' || image_url !== '' || title !== '' || subtitle !== '' || icon_value !== '' || link !== '' || choice !== '' || social_repeater !== '' || shortcode !== '' || color !== '' || newtab !=='' ) {
                values.push({
...
jQuery(document).ready(function () {
    ...
    theme_conrols.on('click', '.customizer-repeater-new-field', function () {
		...
		if(parentid == 'customize-control-slider_repeater')
		{	
			var itms = jQuery("#customize-control-slider_repeater .customizer-repeater-general-control-repeater-container").length 
			if(itms >= 2){ 
			  jQuery( "#customize-control-slider_upgrade_notice .pluglab-upgrade-pro-message" ).show();
			  return;   
			}
		}
		if(parentid == 'customize-control-service_repeater')
		{
			var itms = jQuery("#customize-control-service_repeater .customizer-repeater-general-control-repeater-container").length 
			if(itms >= 3){ 
			  jQuery( "#customize-control-service_upgrade_notice .pluglab-upgrade-pro-message" ).show();
			  return;   
			}
		}
		if(parentid == 'customize-control-testimonial_repeater')
		{
			var itms = jQuery("#customize-control-testimonial_repeater .customizer-repeater-general-control-repeater-container").length 
			if(itms >= 3){ 
			  jQuery( "#customize-control-testimonial_upgrade_notice .pluglab-upgrade-pro-message" ).show();
			  return;   
			}
		}
        ...
        if (typeof th !== 'undefined') {
            ...
            if (typeof field !== 'undefined') {
                ...
                /*Remove value from checkox field*/
    ...
    theme_conrols.on('click', '.customizer-repeater-checkbox', function () {
        if (this.checked) {
            this.setAttribute("checked", "checked");this.setAttribute("value", "yes");
        } else {
            this.removeAttribute("checked");this.setAttribute("value", "no");
        }
    });
