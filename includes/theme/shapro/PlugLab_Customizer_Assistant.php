...
class PlugLab_Customizer_Assistant {
...
//        callout icon
        $wp_customize->selective_refresh->add_partial( 'callout1_icon', array(
		'selector'            => '.section.features .col-md-4:nth-child(1) i',
		'settings'            => 'callout1_icon',
                'render_callback' =>  function(){return get_theme_mod('callout1_icon');}
	
	) );
        $wp_customize->selective_refresh->add_partial( 'callout2_icon', array(
		'selector'            => '.section.features .col-md-4:nth-child(2) i',
		'settings'            => 'callout2_icon',
            'render_callback' =>  function(){return get_theme_mod('callout2_icon');}
	
	) );
        $wp_customize->selective_refresh->add_partial( 'callout3_icon', array(
		'selector'            => '.section.features .col-md-4:nth-child(3) i',
		'settings'            => 'callout3_icon',
            'render_callback' =>  function(){return get_theme_mod('callout3_icon');}
	
	) );
//        callout Title
        $wp_customize->selective_refresh->add_partial( 'callout1_title', array(
		'selector'            => '.section.features .col-md-4:nth-child(1) h5',
		'settings'            => 'callout1_title',
            'render_callback' =>  function(){return get_theme_mod('callout1_title');}
	
	) );
        $wp_customize->selective_refresh->add_partial( 'callout2_title', array(
		'selector'            => '.section.features .col-md-4:nth-child(2) h5',
		'settings'            => 'callout2_title',
            'render_callback' =>  function(){return get_theme_mod('callout2_title');}
	
	) );
        $wp_customize->selective_refresh->add_partial( 'callout3_title', array(
		'selector'            => '.section.features .col-md-4:nth-child(3) h5',
		'settings'            => 'callout3_title',
            'render_callback' =>  function(){return get_theme_mod('callout3_title');}
	
	) );
//        callout Description
        $wp_customize->selective_refresh->add_partial( 'callout1_desc', array(
		'selector'            => '.section.features .col-md-4:nth-child(1) p',
		'settings'            => 'callout1_desc',
            'render_callback' =>  function(){return get_theme_mod('callout1_desc');}
	
	) );
        $wp_customize->selective_refresh->add_partial( 'callout2_desc', array(
		'selector'            => '.section.features .col-md-4:nth-child(2) p',
		'settings'            => 'callout2_desc',
            'render_callback' =>  function(){return get_theme_mod('callout2_desc');}
	
	) );
        $wp_customize->selective_refresh->add_partial( 'callout3_desc', array(
		'selector'            => '.section.features .col-md-4:nth-child(3) p',
		'settings'            => 'callout3_desc',
            'render_callback' =>  function(){return get_theme_mod('callout3_desc');}
...
//        Service
		...
		'settings'            => 'service_sub_title',
            'render_callback' =>  function(){return get_theme_mod('service_sub_title');}
	
	) );
        $wp_customize->selective_refresh->add_partial( 'service_description', array(
		'selector'            => '#service-section .section-heading p',
		'settings'            => 'service_description',
            'render_callback' =>  function(){return get_theme_mod('service_description');}
	
	) );
        $wp_customize->selective_refresh->add_partial( 'service_repeater', array(
		'selector'            => '#service-section .row',
		'settings'            => 'service_repeater',
            'render_callback' =>  function(){return get_theme_mod('service_repeater');}
...
//        Testimonial
		...
		'settings'            => 'testimonial_title',
            'render_callback' =>  function(){return get_theme_mod('testimonial_title');}
		...
		'settings'            => 'testimonial_sub_title',
            'render_callback' =>  function(){return get_theme_mod('testimonial_sub_title');}
		...
		'settings'            => 'testimonial_description',
            'render_callback' =>  function(){return get_theme_mod('testimonial_description');}
	
	) );
        $wp_customize->selective_refresh->add_partial( 'testimonial_repeater', array(
		'selector'            => '.section.testimonials .row',
		'settings'            => 'testimonial_repeater',
            'render_callback' =>  function(){return get_theme_mod('testimonial_repeater');}
...
//        Blogs
		...
		'settings'            => 'blog_sub_title',
            'render_callback' =>  function(){return get_theme_mod('blog_sub_title');}
	
	) );
        $wp_customize->selective_refresh->add_partial( 'blog_description', array(
		'selector'            => '.section.blogs .section-heading p',
		'settings'            => 'blog_description',
            'render_callback' =>  function(){return get_theme_mod('blog_description');}
