...
use \Plug_Lab\Customizer\Controls\PlugLab_Toggle_Switch_Custom_control;
use \Plug_Lab\Customizer\Controls\PlugLab_TinyMCE_Custom_control;
use \Plug_Lab\Customizer\Controls\PlugLab_Sortable_Repeater_Custom_Control;
use Plug_Lab\Customizer\Controls\PlugLab_customizer_repeater as Customizer_Repeater;
use Plug_Lab\Customizer\Controls\PlugLab_Dropdown_Select2_Custom_Control as Pluglab_Dropdown_Select2_Custom_Control;
use \WP_Customize_Media_Control;
//use Plug_Lab\Customizer\Controls\PlugLab_Customizer_Assistant as PlugLab_Customizer_Assistant;
use Plug_Lab\Customizer\Controls\PlugLab_Customizer_Range_Slider_Control as PlugLab_Customizer_Range_Slider_Control;
use Plug_Lab\Customizer\Controls\PlugLab_customzier_Icon_Picker_Control as PlugLab_customzier_Icon_Picker_Control;
use Plug_Lab\Customizer\Controls\PlugLab_customizer_Page_Editor as Customizer_Page_Editor;
use Plug_Lab\Customizer\Controls\PlugLab_Separator_Section as Heading;
use Plug_Lab\Customizer\Controls\PlugLab_Upgrade_Notice as PlugLab_Upgrade_Notice;

//use Plug_Lab\Customizer\Controls\PlugLab_Sanitize_Callback as Sanitize_Callback;

/**
 * Adds the individual sections, settings, and controls to the theme customizer
 */
class pluglab_initialise_customizer_settings {
    ...
    public function __construct() {
        ...
        $this->sections = array('slider_upgrade_notice'=>'slider_section','service_upgrade_notice'=>'service_section','testimonial_upgrade_notice'=>'testimonial_section');
    ...
    public function pluglab_bsns_tmp_customizer_panel($wp_customize) {
        $wp_customize->add_panel('homepage_template_settings', array(
            'title' => __('Homepage Template Settings'),
    ...
    public function pluglab_bsns_tmp_customizer_section($wp_customize) {
        ...
        $wp_customize->add_section('slider_section',
                array(
                    'title' => __('Slider banner image', 'pluglab'),
    ...
    function header($wp_customize)
    {
       ...
       // Logo Width // 
        ...
        new PlugLab_Customizer_Range_Slider_Control( $wp_customize, 'logo_width', 
            array(
    ...
    $wp_customize->add_control(new PlugLab_customzier_Icon_Picker_Control($wp_customize, 
        'top_mail_icon',
        array(
    ...
    //Top Text //
    $wp_customize->add_setting('top_header_mail_text',
                array(
                    'default' => 'youremail@gmail.com',
                    'sanitize_callback' => 'wp_filter_nohtml_kses',
                )
        );
        $wp_customize->add_control('top_header_mail_text',
                array(
    ...
    //Top Text //
    $wp_customize->add_setting('top_header_phone_text',
                array(
                    'default' => '134-566-7680',
                )
        );
        $wp_customize->add_control('top_header_phone_text',
                array(
     ...
     * Customizer Repeater
     */
        $wp_customize->add_setting( 'shapro_social_icons', 
            array(
        ...
        $wp_customize->add_control( 
            new Customizer_Repeater( $wp_customize, 
                'shapro_social_icons', 
                    array(
        ...
        $wp_customize->add_setting('hire_btn_text',
                array(
                    'default' => 'HIRE US!',
                )
        );
        $wp_customize->add_control('hire_btn_text',
                array(
    ...
    function slider($wp_customize) {
        $wp_customize->add_setting('slider_display',
                array(
        ...
        $wp_customize->add_control(new PlugLab_Toggle_Switch_Custom_control($wp_customize, 'slider_display',
                        array(
                    'priority' => 1,
        ...
        $wp_customize->add_setting('slider_repeater', array(
            'sanitize_callback' => 'customizer_repeater_sanitize'
        ));
        $wp_customize->add_control(new Customizer_Repeater($wp_customize, 'slider_repeater', array(
                    'label' => esc_html__('Slider Items Content', 'customizer-repeater'),
                    'section' => 'slider_section',
                    'priority' => 4,
                    'add_field_label' => esc_html__('Add new slider item', 'pluglab'),
                    'item_name' => esc_html__('Slider Item', 'pluglab'),
    ...
    function callout($wp_customize) {
        ...
        $wp_customize->add_setting('callout_display',
                array(
        ...
        $wp_customize->add_control(new PlugLab_Toggle_Switch_Custom_control($wp_customize, 'callout_display',
                        array(
                    'priority' => 1,
                    'label' => __('Display', 'pluglab'),
         ...
         $wp_customize->add_setting('callouthead',
                array()
        );
        $wp_customize->add_control(new Heading($wp_customize, 'callouthead',
                        array(
                            'type'=>'heading',
                    'label' => __('Displaysdfasfd', 'pluglab'),
                    'section' => 'callout_section'
                        )
        ));
        
        //callout1
        $wp_customize->add_setting('callout1_icon',
                array(
                    'default' => $this->defaults['callout_icon'],
                    'transport' => 'refresh',
                    'sanitize_callback' => 'wp_filter_nohtml_kses'
                )
        );
        $wp_customize->add_control('callout1_icon',
                array(
                    'label' => __('Font Awsome class', 'pluglab'),
                    'section' => 'callout_section',
                    'type' => 'text'
                )
        );

        $wp_customize->add_setting('callout1_title',
                array(
                    'default' => $this->defaults['callout_title'],
                    'transport' => 'postMessage',
                    'sanitize_callback' => 'wp_filter_nohtml_kses'
                )
        );
        $wp_customize->add_control('callout1_title',
                array(
        ...
        $wp_customize->add_setting('callout1_desc',
                array(
                    'default' => $this->defaults['callout_description'],
                    'transport' => 'postMessage',
                    'sanitize_callback' => 'wp_filter_nohtml_kses'
                )
        );
        $wp_customize->add_control('callout1_desc',
                array(
        ...
        //callout2
        $wp_customize->add_setting('callout2_icon',
                array(
                    'default' => $this->defaults['callout_icon'],
                    'transport' => 'refresh',
                    'sanitize_callback' => 'wp_filter_nohtml_kses'
        ...
        $wp_customize->add_setting('callout2_title',
                array(
                    'default' => $this->defaults['callout_title'],
                    'transport' => 'postMessage',
                    'sanitize_callback' => 'wp_filter_nohtml_kses'
        ...
        $wp_customize->add_control('callout2_title',
                array(
                    'label' => __('Title', 'pluglab'),
                    'section' => 'callout_section',
                    'type' => 'text',
        ...
        $wp_customize->add_setting('callout2_desc',
                array(
                    'default' => $this->defaults['callout_description'],
                    'transport' => 'postMessage',
                    'sanitize_callback' => 'wp_filter_nohtml_kses'
        ...
        $wp_customize->add_control('callout2_desc',
                array(
                    'label' => __('Description', 'pluglab'),
                    'section' => 'callout_section',
                    'type' => 'text',
        ...
        //callout3
        $wp_customize->add_setting('callout3_icon',
                array(
                    'default' => $this->defaults['callout_icon'],
                    'transport' => 'refresh',
                    'sanitize_callback' => 'wp_filter_nohtml_kses'
        ...
        $wp_customize->add_control('callout3_icon',
                array(
                    'label' => __('Font Awsome class', 'pluglab'),
                    'section' => 'callout_section',
                    'type' => 'text'
        ...
        $wp_customize->add_setting('callout3_title',
                array(
                    'default' => $this->defaults['callout_title'],
                    'transport' => 'postMessage',
                    'sanitize_callback' => 'wp_filter_nohtml_kses'
        ...
        $wp_customize->add_control('callout3_title',
                array(
                    'label' => __('Title', 'pluglab'),
                    'section' => 'callout_section',
                    'type' => 'text',
        ...
        $wp_customize->add_setting('callout3_desc',
                array(
                    'default' => $this->defaults['callout_description'],
                    'transport' => 'postMessage',
                    'sanitize_callback' => 'wp_filter_nohtml_kses'
        ...
        $wp_customize->add_control('callout3_desc',
                array(
                    'label' => __('Description', 'pluglab'),
                    'section' => 'callout_section',
                    'type' => 'text',
    ...
    function cta($wp_customize) {
        ...
        $wp_customize->add_control(new PlugLab_Toggle_Switch_Custom_control($wp_customize, 'cta_display',
                        array(
                    'priority' => 1,
                    'label' => __('Display', 'pluglab'),
                    'section' => 'cta_section'
        ...
        $wp_customize->add_setting('cta_btn_read',
                array(
        ...
        $wp_customize->add_control('cta_btn_read',
                array(
                    'label' => __('Button Text', 'pluglab'),
                    'section' => 'cta_section',
                    'type' => 'text',
    ...
    function service($wp_customize) {
        $wp_customize->add_setting('service_display',
                array(
        ...
        $wp_customize->add_control(new PlugLab_Toggle_Switch_Custom_control($wp_customize, 'service_display',
                        array(
                    'priority' => 1,
                    'label' => __('Display', 'pluglab'),
        ...
        $wp_customize->selective_refresh->add_partial('service_display',
                array(
                    'selector' => '.social',
        ...
        $wp_customize->add_control('service_description',
                array(
        ...
        $wp_customize->add_setting('service_repeater', array(
            'sanitize_callback' => 'customizer_repeater_sanitize'
        ));
        $wp_customize->add_control(new Customizer_Repeater($wp_customize, 'service_repeater', array(
                    'label' => esc_html__('Service Items Content', 'customizer-repeater'),
                    'section' => 'service_section',
                    'priority' => 5,
                    'add_field_label' => esc_html__('Add new service item', 'pluglab'),
                    'item_name' => esc_html__('Service Item', 'pluglab'),
                    'customizer_repeater_image_control' => true,
                    'customizer_repeater_icon_control' => true,
                    'customizer_repeater_image_icon_choice_control' => false,
                    'customizer_repeater_title_control' => true,
    ...
    function testimonial($wp_customize) {
        $wp_customize->add_setting('testimonial_display',
                array(
        ...
        $wp_customize->add_control(new PlugLab_Toggle_Switch_Custom_control($wp_customize, 'testimonial_display',
                        array(
                    'priority' => 1,
                    'label' => __('Display', 'pluglab'),
        ...
        $wp_customize->add_setting('testimonial_sub_title',
                array(
        ...
        $wp_customize->add_control('testimonial_sub_title',
                array(
        ...
        $wp_customize->add_setting('testimonial_description',
                array(
        ...
        $wp_customize->add_control('testimonial_description',
                array(
        ...
        $wp_customize->add_setting('testimonial_repeater', array(
            'sanitize_callback' => 'customizer_repeater_sanitize'
        ));
        $wp_customize->add_control(new Customizer_Repeater($wp_customize, 'testimonial_repeater', array(
                    'label' => esc_html__('Testimonial Items Content', 'customizer-repeater'),
                    'section' => 'testimonial_section',
                    'priority' => 5,
                    'add_field_label' => esc_html__('Add new testinonial', 'pluglab'),
                    'item_name' => esc_html__('Testinonial Item', 'pluglab'),
                    'customizer_repeater_image_control' => true,
                    'customizer_repeater_image_icon_choice_control' => false,
                    'customizer_repeater_title_control' => true,
                    'customizer_repeater_subtitle_control' => true,
    ...
    function blog($wp_customize) {
        $wp_customize->add_setting('blog_display',
                array(
        ...
        $wp_customize->add_control(new PlugLab_Toggle_Switch_Custom_control($wp_customize, 'blog_display',
                        array(
                    'priority' => 1,
                    'label' => __('Display', 'pluglab'),
        ...
        $wp_customize->add_setting('blog_meta_display',
                array(
        ...
        $wp_customize->add_control(new PlugLab_Toggle_Switch_Custom_control($wp_customize, 'blog_meta_display',
                        array(
                    'priority' => 5,
        ...
        $wp_customize->add_setting('shapro_theme_blog_category',
                array(
        ...
        $wp_customize->add_control(new Pluglab_Dropdown_Select2_Custom_Control($wp_customize, 'shapro_theme_blog_category',
                        array(
    ...
    function upgradeNotice($wp_customize) {
        ...
        foreach($this->sections as $id=>$section){
            ...
            $wp_customize->add_control(new PlugLab_Upgrade_Notice($wp_customize, $id, array('label' => 'upgrade', 'section' => $section, 'setting' => $id)));
        }
    ...
    function generate_defaults() {
        $customizer_defaults = array(
            ...
            'callout_display' => 1,
            'callout_icon' => 'fa-bullseye',
            'callout_title' => 'heading...',
            'callout_description' => 'brief...',
            'slider_display' => 1,
            'social_newtab' => 1,
            'service_display' => 1,
